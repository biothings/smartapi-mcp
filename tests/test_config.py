...
class TestLoadConfig:
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_environment_variables(self, mock_base_load_config, mock_logger):
        ...
        assert config.smartapi_ids == "id1,id2"  # Note: still string, not parsed as list
        ...
        assert "SMARTAPI_ID, SMARTAPI_IDS, SMARTAPI_EXCLUDE_IDS, SMARTAPI_Q, SMARTAPI_API_SET, SERVER_NAME" in debug_call

    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_partial_environment_variables(self, mock_base_load_config, mock_logger):
        ...
        env_vars = {
            "SMARTAPI_ID": "partial_env_id",
            "SMARTAPI_Q": "partial env query"
        }
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_args_smartapi_id(self, mock_base_load_config, mock_logger):
        ...
        mock_logger.debug.assert_called_with(f"Setting SmartAPI id from arguments: args_test_id")

    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_args_smartapi_ids(self, mock_base_load_config, mock_logger):
        ...
        # Note: The code has a bug where it checks args.smartapi_id instead of args.smartapi_ids
        args = SimpleNamespace()
        ...
        mock_logger.debug.assert_called_with(f"Setting SmartAPI ids from arguments: {['args_id1', 'args_id2']}")

    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_args_smartapi_exclude_ids(self, mock_base_load_config, mock_logger):
    ...
    def test_load_config_with_args_smartapi_q(self, mock_base_load_config, mock_logger):
        ...
        mock_logger.debug.assert_called_with(f"Setting SmartAPI query from arguments: args query test")
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_args_server_name(self, mock_base_load_config, mock_logger):
        ...
        mock_logger.debug.assert_called_with(f"Setting MCP Server name from arguments: custom_args_server")
    ...
    def test_load_config_with_args_transport(self, mock_base_load_config, mock_logger):
        ...
        mock_logger.debug.assert_called_with(f"Setting MCP Server transport mode from arguments: http")
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_args_with_empty_values(self, mock_base_load_config, mock_logger):
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_args_without_attributes(self, mock_base_load_config, mock_logger):
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_with_base_config_fields(self, mock_base_load_config, mock_logger):
        ...
        with patch("smartapi_mcp.config.fields", return_value=[mock_field1, mock_field2]):
            config = load_config()
    ...
    @patch("smartapi_mcp.config.logger")
    @patch("awslabs.openapi_mcp_server.api.config.load_config")
    def test_load_config_no_env_variables_loaded(self, mock_base_load_config, mock_logger):
        ...
        env_vars_to_clear = [
            "SMARTAPI_ID", "SMARTAPI_IDS", "SMARTAPI_EXCLUDE_IDS", 
            "SMARTAPI_Q", "SMARTAPI_API_SET", "SERVER_NAME"
        ]
